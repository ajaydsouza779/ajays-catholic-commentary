...
async function fixPrayerAndRecreate() {
  ...
  try {
    ...
    // Step 3: Create the new post with improved personal prayer
    console.log('\n📝 Creating new post with improved personal prayer...');
    
    const contentWithImprovedPrayer = `
<div class="max-w-4xl mx-auto">
  ...
  <div class="space-y-8">
    ...
    `, [contentWithImprovedPrayer, authorId]);
    
    console.log('✅ New post created with improved personal prayer');
    ...
    console.log('\n🎉 Post successfully recreated with improved personal prayer!');
    console.log('✅ Prayer now uses "I" and "my" instead of "we" and "our"');
    console.log('✅ Added "Say a Small Prayer" title');
    console.log('✅ Improved grammar and personal tone');
    console.log('✅ Clean formatting maintained');
    
    // Note for future reference
    console.log('\n📝 NOTE FOR FUTURE:');
    console.log('⚠️ When updating content, always use DELETE and RECREATE approach');
    console.log('⚠️ Avoid UPDATE statements that can corrupt HTML formatting');
    console.log('⚠️ Test formatting changes in a clean environment first');
